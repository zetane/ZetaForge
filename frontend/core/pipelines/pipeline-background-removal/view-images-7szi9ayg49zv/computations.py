...
def compute(image_paths_view):
    ...
    Inputs:
        image_paths_view (str or list): A path or a list of image paths to display in the gallery.
...
<body>
    ...
    """
    # Ensure image_paths_view is always a list
    if isinstance(image_paths_view, str):
        image_paths_view = [image_paths_view]
