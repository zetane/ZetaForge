        ...
        <div className="drawflow_content_node">
          ...
          <div className="block-body">
            <div className="block-io">
              <BlockInputs inputs={block.inputs} id={id} history={history} block={block}/>
              <BlockOutputs outputs={block.outputs} id={id}  history={history} block={block}/>
            </div>
            {content}
          </div>
        </div>
...
const BlockInputs = ({ inputs, id, history }) => (
...
const BlockOutputs = ({ outputs, id, history }) => (
